"""wrap_serial.py – nízkoúrovňové I/O pro hoverboard přes UART (Time‑Critical)

⚠️ DŮLEŽITÉ: Soubor je pojmenován **wrap_serial.py** (ne `serial.py`),
...
class WrpaConfig:
    ...
    log_dir: str = "/data/robot/heading" #DEFAULT_LOG_DIR
