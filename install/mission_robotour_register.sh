...
SERVICE_DIR="$PROJECT_DIR/mission-robotour"

SERVICE_NAME="robot-mission-robotour.service"
SERVICE_PATH="/etc/systemd/system/$SERVICE_NAME"
LOG_DIR="/data/logs/mission_robotour"
LOG_FILE="$LOG_DIR/mission_robotour.log"
DATA_DIR="/data/robot/mission-robotour"
...
echo "📁 Vytvářím runtime data složku pro mise ($DATA_DIR)..."
...
[Unit]
Description=Robotour 2025 - Mission Robotour Orchestrator (Python)
...
# Před spuštěním ukonči libovolný proces, který drží port 9031
ExecStartPre=/bin/bash -c '/usr/bin/fuser -k 9031/tcp || true'
